...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 8339
   - **Unique Online Proxies** -> 7490
   - **Unique Online/Offline Proxies (Archive)** -> 55246

## [SOCKS4 (4904/7490)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.1.231.200:4145
1.2.202.165:4145
1.4.157.35:36202
...
## [SOCKS5 (191/7490)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.116.4.222:7890
5.56.134.237:45698
8.131.254.15:9999
...
## [HTTP (1634/7490)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.1.189.58:8080
1.2.252.65:8080
1.10.187.237:8080
...
## [HTTPS (1610/7490)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.1.189.58:8080
1.1.220.100:8080
1.2.252.65:8080
...
## [ARCHIVE (7490/55246)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/working-proxies-history.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327

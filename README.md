...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 8787
   - **Unique Online Proxies** -> 7909
   - **Unique Online/Offline Proxies (Archive)** -> 55304

## [SOCKS4 (5306/7909)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.0.133.100:51327
1.4.157.35:36202
1.4.214.148:5678
...
## [SOCKS5 (232/7909)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.116.4.222:7890
5.56.134.237:45698
5.61.53.57:9100
...
## [HTTP (1965/7909)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.0.205.87:8080
1.1.189.58:8080
1.2.252.65:8080
...
## [HTTPS (1284/7909)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.205.87:8080
1.10.187.237:8080
1.20.217.221:8080
...
## [ARCHIVE (7909/55304)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/working-proxies-history.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327

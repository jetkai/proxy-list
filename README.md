...
- _Proxies (Total):_
   - **Online Proxies (SOCKS4/5 + HTTP/S)** -> 9212
   - **Unique Online Proxies** -> 8068
   - **Unique Online/Offline Proxies (Archive)** -> 55284

## [SOCKS4 (5167/8068)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks4.txt)
```yaml
1.0.132.249:4153
1.0.133.100:51327
1.2.202.165:4145
...
## [SOCKS5 (273/8068)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-socks5.txt)
```yaml
1.116.4.222:7890
5.45.73.63:9050
5.61.53.57:9300
...
## [HTTP (1828/8068)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt)
```yaml
1.0.205.87:8080
1.1.189.58:8080
1.4.157.35:46944
...
## [HTTPS (1944/8068)](https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt)
```yaml
1.0.205.87:8080
1.2.252.65:8080
1.4.157.35:46944
...
## [ARCHIVE (8068/55284)](https://raw.githubusercontent.com/jetkai/proxy-list/main/archive/txt/working-proxies-history.txt)
```yaml
1.0.132.249:4153
1.0.133.89:4153
1.0.133.100:51327
